...
class CVAT:
    ...
    def initialization(self):
        ...
        instance = self.attributes_value_dict['instance']
        self.cvat_object_label['name'] = str(shape+'_'+color+','+instance)
...
if __name__=='__main__':
    ...
    for i in range(5768, 5770):
        cvat_array = []
        input_path = './json_input/CATER_new_00{}.json'.format(str(i))
        output_path = './json_output/CATER_new_00{}.json'.format(str(i))
        frame = 0
